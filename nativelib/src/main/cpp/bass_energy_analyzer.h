...
private:
    ...
    // ==================== 音乐/节奏模式处理 ====================
    /**
     * aubio onset + 能量分析 混合方案:
     *
     * 1. aubio (specflux) 做主 onset 检测 — 专业频谱 flux 算法，精准
     * 2. 我们的瞬时能量比率做辅助/备用检测 — 零延迟
     * 3. 振动强度由能量分析计算 — aubio 只提供 onset 时机
     *
     * aubio 优于手写方案的原因:
     * - 使用 FFT + 相位声码器 + spectral flux
     * - 自适应频谱白化 (adaptive whitening)
     * - 学术级 peak-picking 算法
     * - 能检测所有乐器的 onset，不仅限于鼓
     */
